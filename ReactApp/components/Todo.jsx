            ...
            <div className='border border-[#c5c5c5] w-80 bg-[#F9FAFB] rounded-xl px-4 py-4 hover:shadow-lg'>
                <div className="flex justify-between">
                    ...
                    <div className="completeBtn flex">
                        <input type="checkbox" name={`checkinput-${props.item.id}`}  className={`w-10 h-5 mt-2 ${(!(props.item.completed))?"block":"hidden"}`} onClick={()=>{props.MarkAsComplete(props.item.id)}}/>
                ...
                <div className='flex w-full justify-between items-center'>
                    ...
                    <div className='border border-black rounded-full p-1 hover:cursor-pointer' onClick={() => { props.DelTodo(props.item.id) }}>
