...
const SideNav = () => {
    ...
    const{SideNavUI}=Context;
    return (
        <>
            <div className={`flex flex-col w-fit h-[100vh] px-8 space-y-12 py-10 justify-center z-20 relative max-[1368px]:px-4 ${localStorage.getItem("TodoAppMode")==="dark"?"border border-l-0 border-t-0 border-b-0":"border-0"} max-[1025px]:absolute max-[1025px]:-left-40`} style={{backgroundColor:SideNavUI.bg,color:SideNavUI.text}} id="SideNav">
