        ...
        <div className="pr-10">
            <div className='flex w-full justify-between'>
                ...
                <div className="search flex">
                    <input type="text" placeholder='Search' className='bg-transparent border border-[#212731] w-[18rem] h-9 rounded-l-md px-6 focus:outline-none focus:border-2 border-r-0' />
